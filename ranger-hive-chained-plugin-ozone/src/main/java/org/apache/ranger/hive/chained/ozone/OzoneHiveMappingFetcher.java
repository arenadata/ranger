...
public class OzoneHiveMappingFetcher extends HiveMappingFetcher {
    public OzoneHiveMappingFetcher(RangerAdminClient adminClient,
                                   HiveResourceMappingStore mappingStore,
                                   long refreshInterval, long mappingsFlushInterval, String targetService) {
